...
const CircleProgress = ({ progress, timeLeft })=>{
    const radius = 50;
        ...
        "WorkoutTracker.useEffect": ()=>{
            if (workoutState === 'RESTING') {
                ...
                const timerId = setInterval({
                    "WorkoutTracker.useEffect.timerId": ()=>setTimeLeft({
                            "WorkoutTracker.useEffect.timerId": (t)=>t - 1
                        }["WorkoutTracker.useEffect.timerId"])
                }["WorkoutTracker.useEffect.timerId"], 1000);
                return ({
                    "WorkoutTracker.useEffect": ()=>clearInterval(timerId)
                })["WorkoutTracker.useEffect"];
            }
        }
    }["WorkoutTracker.useEffect"], [
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CircleProgress, {
                    progress: timeLeft / REST_DURATION * 100,
                    timeLeft: timeLeft
                }, void 0, false, {
                    fileName: "[project]/src/components/workout/WorkoutTracker.tsx",
                    lineNumber: 166,
...
_s(WorkoutTracker, "LuR3Qe035To5q74sZcBnZ8oMzBQ=", false, function() {
    return [
...
//# sourceMappingURL=src_components_359f687c._.js.map