...
function WorkoutPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WorkoutPage.useEffect": ()=>{
            ...
            ;
            let foundWorkout = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$workouts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["workouts"][slug];
            if (!foundWorkout) {
                ...
                if (customWorkoutsStr) {
                    try {
                        ...
                        foundWorkout = customWorkouts.find({
                            "WorkoutPage.useEffect": (w)=>w.id === slug
                        }["WorkoutPage.useEffect"]);
                    } catch (e) {
                        console.error("Failed to parse custom workouts from localStorage", e);
                        foundWorkout = undefined;
                    }
                }
            }
...
//# sourceMappingURL=src_54d2376e._.js.map